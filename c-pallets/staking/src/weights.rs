...
//! Autogenerated weights for pallet_cess_staking
//!
...
/// Weight functions needed for pallet_cess_staking.
...
/// Weights for pallet_cess_staking using the Substrate node and recommended hardware.
