...
pub fn set_mr_signer<T: Config>() {
    let signer: MrSigner = [0x83,0xd7,0x19,0xe7,0x7d,0xea,0xca,0x14,0x70,0xf6,0xba,0xf6,0x2a,0x4d,0x77,0x43,0x03,0xc8,0x99,0xdb,0x69,0x02,0x0f,0x9c,0x70,0xee,0x1d,0xfc,0x08,0xc7,0xce,0x9e];

    MrSignerValue::<T>::put(signer);
}
