...
pub trait SchedulerCreditCounter<SchedulerCtrlAccountId> {
	...
	fn record_proceed_block_size(
		scheduler_id: &SchedulerCtrlAccountId,
		block_size: u64,
	) -> DispatchResult;
...
/// Stash account finder, used to find the corresponding Stash account according to the Controller
/// account
