...
Options:
    ...
    -n <network profile>  options: devnet, testnet, premainnet, mainnet, ownnet
...
if ! [[ $network = "devnet" || $network = "testnet" || $network = "premainnet" || $network = "mainnet" || $network = "ownnet" ]]; then
