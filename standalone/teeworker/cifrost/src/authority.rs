...
use log::info;
use cestory_api::blocks::{AuthoritySet, AuthoritySetChange};
use cesxt::ChainApi;
...
use crate::{chain_client::get_header_at, types::Header};
...
impl StorageKeys {
    ...
    pub fn authorities_v1() -> Vec<u8> {
        cesxt::dynamic::storage_key("Grandpa", "Authorities")
    }
    pub fn current_set_id() -> Vec<u8> {
        cesxt::dynamic::storage_key("Grandpa", "CurrentSetId")
    }
}
