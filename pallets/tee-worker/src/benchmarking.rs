...
pub fn generate_workers() {
    let stash_account = pallet_cess_staking::testing_utils::create_stash_controller::<T>(USER_SEED, 100, Default::default())?;
...
pub fn sign_message(msg: &[u8]) -> sp_core::sr22519::Signature {
    let pair = sp_core::sr25519::Pair::from_string(&format!("{}//Alice", DEV_PHRASE), None).unwrap();
    pair.sign(msg)
}
